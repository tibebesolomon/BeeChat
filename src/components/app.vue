...
var firebaseConfig = {
  apiKey: "AIzaSyBRDCmRvOHl_Qf0m4Kra1Oc6LTFAmDpPSw",
  authDomain: "whatchat-7bcc6.firebaseapp.com",
  databaseURL: "https://whatchat-7bcc6.firebaseio.com",
  projectId: "whatchat-7bcc6",
  storageBucket: "whatchat-7bcc6.appspot.com",
  messagingSenderId: "958322740726",
  appId: "1:958322740726:web:2c5ffc993d1c4541c9cbd7",
  measurementId: "G-1RT1MLPDEH",
};
// Initialize Firebase
...
export default {
  data() {
    return {
      ...
      f7params: {
        id: "io.framework7.beechat", // App bundle ID
        name: "BeeChat", // App name
